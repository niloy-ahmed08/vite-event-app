...
const Footer = () => {
  return (
    <>
      {/* ইমেজটি public ফোল্ডারে রেখে সরাসরি এখানে নিখুঁতভাবে পাথটি সেট করে দেওয়া হলো */}
      <footer id='contect' className="bg-[url('/footers.png')] bg-cover bg-center bg-no-repeat py-26.75 px-55 pb-15.5">
        <Container>
          <div className=''>
            <div className='flex justify-between'>
              {/* h-[] খালি ছিল, ওটা রিমুভ করা হয়েছে */}
              <h1 className='text-[48px] leading-[52px] font-semibold text-white w-159.5'>
                Join our newsletter for event important announcement
              </h1>
              <div>
                <div className='flex items-center gap-1'>
                  <MdOutlineNotificationsActive className='text-white w-10 h-10'/>
                  <h1 className='text-[16px] leading-[23px] font-normal text-[#FFFFFF]'>
            ...
            <div className='mt-23.75 flex justify-between'>
              <div>
                <p className='text-[16px] font-normal leading-5.75 text-white mt-8 w-97.25'>
